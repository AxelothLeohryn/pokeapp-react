...
const cardRender = (
  <Router>
    <PokemonContext.Provider value={{ pokemons: [], setPokemons: () => {} }}>
      <Card pokemon={testPokemon} />
    </PokemonContext.Provider>
  </Router>
);
describe("Card", () => {
  it("renders Card component and it is visible", () => {
    render(cardRender);
    expect(screen.getByTestId("Card")).toBeVisible();
  });

  it('contains an element with testId "Card_title"', () => {
    render(cardRender);
    expect(screen.getByTestId("Card_title")).toBeInTheDocument();
  });

  it('contains an element with testId "Card_img"', () => {
    render(cardRender);
    expect(screen.getByTestId("Card_img")).toBeInTheDocument();
  });

  // it('displays the name in "Card__title" when "name" prop is provided', () => {
  //   const testName = 'Pikachu';
  //   render(<Card name={testName} />);
  //   expect(screen.getByTestId('Card__title')).toHaveTextContent(testName);
  // });

  // it('uses the correct image src in "Card__img" when "sprites.front_default" prop is provided', () => {
  //   const testImage = 'http://example.com/sprite.png';
  //   render(<Card sprites={{ front_default: testImage }} />);
  //   expect(screen.getByTestId('Card__img')).toHaveAttribute('src', testImage);
  // });
});
